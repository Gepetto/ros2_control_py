...
class PyControllerInterfaceBase: public ControllerInterfaceBase {
 public:
  ...
  std::vector<hardware_interface::StateInterface::ConstSharedPtr> export_state_interfaces() override {
    PYBIND11_OVERRIDE_PURE(
  ...
  std::vector<hardware_interface::CommandInterface::SharedPtr> export_reference_interfaces() override {
    PYBIND11_OVERRIDE_PURE(
...
inline void init_controller_interface_base([[maybe_unused]] py::module &m)
{
  ...
  py::class_<ControllerInterfaceBase, rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface, PyControllerInterfaceBase>(m, "ControllerInterfaceBase")
      .def(py::init<>())
      .def("command_interface_configuration", &ControllerInterfaceBase::command_interface_configuration)
      .def("state_interface_configuration", &ControllerInterfaceBase::state_interface_configuration)
      .def("release_interfaces", &ControllerInterfaceBase::release_interfaces)
      .def("init", [](ControllerInterfaceBase& self,
                      const std::string& controller_name,
                      const std::string& urdf,
                      unsigned int cm_update_rate,
                      const std::string& namespace_,
                      const rclcpp::NodeOptions& node_options)
      { return self.init(controller_name, urdf, cm_update_rate, namespace_, node_options); })
      ...
      .def("get_node", [](ControllerInterfaceBase& self) { return self.get_node(); })
      .def("get_update_rate", &ControllerInterfaceBase::get_update_rate)
      .def("is_chainable", &ControllerInterfaceBase::is_chainable)
      .def("export_reference_interfaces", &ControllerInterfaceBase::export_reference_interfaces)
