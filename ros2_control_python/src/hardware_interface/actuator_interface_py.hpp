 ...
 public:
  ...
  std::vector<StateInterface::ConstSharedPtr> on_export_state_interfaces() override {
    PYBIND11_OVERRIDE_PURE(
        std::vector<StateInterface::ConstSharedPtr>,
        ActuatorInterface,
  ...
  std::vector<CommandInterface::SharedPtr> on_export_command_interfaces() override {
    PYBIND11_OVERRIDE_PURE(
        std::vector<CommandInterface::SharedPtr>,
        ActuatorInterface,
  ...
  return_type prepare_command_mode_switch(const std::vector<std::string>& arg0, const std::vector<std::string>& arg1) override {
    PYBIND11_OVERRIDE(
        return_type,
        ActuatorInterface,
  ...
  return_type perform_command_mode_switch(const std::vector<std::string>& arg0, const std::vector<std::string>& arg1) override {
    PYBIND11_OVERRIDE(
        return_type,
        ActuatorInterface,
...
{
  py::class_<ActuatorInterface, rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface, PyActuatorInterface>(m, "ActuatorInterface")
      .def(py::init<>())
      .def("on_init", &ActuatorInterface::on_init)
      .def("on_export_state_interfaces", &ActuatorInterface::on_export_state_interfaces)
      .def("on_export_command_interfaces", &ActuatorInterface::on_export_command_interfaces)
      .def("prepare_command_mode_switch", &ActuatorInterface::prepare_command_mode_switch)
      .def("perform_command_mode_switch", &ActuatorInterface::perform_command_mode_switch)
      ...
      .def_readwrite("lifecycle_state_", &PubActuatorInterface::lifecycle_state_);
}
