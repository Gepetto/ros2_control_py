...
void init_hardware_interface(py::module &m) {
  py::module hardware_interface = m.def_submodule("hardware_interface");

  py::class_<InterfaceInfo>(hardware_interface, "InterfaceInfo")
      .def(py::init<>())
  ...
  py::class_<ComponentInfo>(hardware_interface, "ComponentInfo")
      .def(py::init<>())
  ...
  py::class_<ControllerInfo>(hardware_interface, "ControllerInfo")
      .def(py::init<>())
  ...
  py::class_<HardwareComponentInfo>(hardware_interface, "HardwareComponentInfo")
      .def(py::init<>())
      ...
      //.def_readwrite("is_async", &HardwareComponentInfo::is_async)
  ...
  py::class_<JointInfo>(hardware_interface, "JointInfo")
      .def(py::init<>())
  ...
  py::class_<ActuatorInfo>(hardware_interface, "ActuatorInfo")
      .def(py::init<>())
  ...
  py::class_<Actuator>(hardware_interface, "Actuator")
      .def(py::init<>())
  ...
  py::class_<TransmissionInfo>(hardware_interface, "TransmissionInfo")
      .def(py::init<>())
  ...
  py::class_<HardwareInfo>(hardware_interface, "HardwareInfo")
      .def(py::init<>())
  ...
  py::class_<ReadOnlyHandle>(hardware_interface, "ReadOnlyHandle")
  ...
  py::class_<ReadWriteHandle>(hardware_interface, "ReadWriteHandle")
      .def(py::init<std::string>())
      .def("set_value", &ReadWriteHandle::get_value);

  py::class_<Sensor>(hardware_interface, "Sensor")
      .def(py::init<>())
  ...
  py::class_<System>(hardware_interface, "System")
      .def(py::init<>())
  ...
  /*py::class_<HardwareReadWriteStatus>(hardware_interface,
