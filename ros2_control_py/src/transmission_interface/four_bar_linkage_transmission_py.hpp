...
inline void init_four_bar_linkage_transmission([[maybe_unused]] py::module &m) {
  m.def("FourBarLinkageTransmission::configure",
        &FourBarLinkageTransmission::configure);

  m.def("FourBarLinkageTransmission::actuator_to_joint",
        &FourBarLinkageTransmission::actuator_to_joint);

  m.def("FourBarLinkageTransmission::joint_to_actuator",
        &FourBarLinkageTransmission::joint_to_actuator);

  m.def("FourBarLinkageTransmission::get_handles_info",
        &FourBarLinkageTransmission::get_handles_info);
  py::class_<FourBarLinkageTransmission, Transmission>(
      m, "FourBarLinkageTransmission")
      ...
      .def_readwrite("actuator_reduction_",
                     &PubFourBarLinkageTransmission::actuator_reduction_)
      .def_readwrite("joint_reduction_",
                     &PubFourBarLinkageTransmission::joint_reduction_)
      .def_readwrite("joint_offset_",
                     &PubFourBarLinkageTransmission::joint_offset_)
      .def_readwrite("joint_position_",
                     &PubFourBarLinkageTransmission::joint_position_)
      .def_readwrite("joint_velocity_",
                     &PubFourBarLinkageTransmission::joint_velocity_)
      .def_readwrite("joint_effort_",
                     &PubFourBarLinkageTransmission::joint_effort_)
      .def_readwrite("actuator_position_",
                     &PubFourBarLinkageTransmission::actuator_position_)
      .def_readwrite("actuator_velocity_",
                     &PubFourBarLinkageTransmission::actuator_velocity_)
      .def_readwrite("actuator_effort_",
                     &PubFourBarLinkageTransmission::actuator_effort_);
}
