...
inline void init_four_bar_linkage_transmission_loader([[maybe_unused]] py::module &m)
{
  py::class_<FourBarLinkageTransmissionLoader, TransmissionLoader>(m, "FourBarLinkageTransmissionLoader")
      .def(py::init<>())
