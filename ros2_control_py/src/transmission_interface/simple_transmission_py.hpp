...
inline void init_simple_transmission([[maybe_unused]] py::module &m) {
  ...
  m.def("SimpleTransmission::actuator_to_joint",
        &SimpleTransmission::actuator_to_joint);

  m.def("SimpleTransmission::joint_to_actuator",
  ...
  py::class_<SimpleTransmission, Transmission>(m, "SimpleTransmission")
      ...
      .def_readwrite("actuator_position_",
                     &PubSimpleTransmission::actuator_position_)
      .def_readwrite("actuator_velocity_",
                     &PubSimpleTransmission::actuator_velocity_)
      .def_readwrite("actuator_effort_",
                     &PubSimpleTransmission::actuator_effort_);
}
