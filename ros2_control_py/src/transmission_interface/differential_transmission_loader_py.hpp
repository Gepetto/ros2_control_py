...
inline void init_differential_transmission_loader([[maybe_unused]] py::module &m)
{
  py::class_<DifferentialTransmissionLoader, TransmissionLoader>(m, "DifferentialTransmissionLoader")
      .def(py::init<>())
