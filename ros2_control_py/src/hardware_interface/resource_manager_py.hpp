...
inline void init_resource_manager([[maybe_unused]] py::module& m) {
  ...
  py::class_<ResourceManager>(m, "ResourceManager")
      ...
      .def("cache_controller_to_hardware",
           &ResourceManager::cache_controller_to_hardware)
      .def("get_cached_controllers_to_hardware",
           &ResourceManager::get_cached_controllers_to_hardware)
      ...
      .def("available_command_interfaces",
           &ResourceManager::available_command_interfaces)
      ...
      .def(
          "import_component",
          [](ResourceManager& self, std::unique_ptr<ActuatorInterface> actuator,
             const HardwareInfo& hardware_info) {
            return self.import_component(std::move(actuator), hardware_info);
          })
      .def("import_component",
           [](ResourceManager& self, std::unique_ptr<SensorInterface> sensor,
              const HardwareInfo& hardware_info) {
             return self.import_component(std::move(sensor), hardware_info);
           })
      .def("import_component",
           [](ResourceManager& self, std::unique_ptr<SystemInterface> system,
              const HardwareInfo& hardware_info) {
             return self.import_component(std::move(system), hardware_info);
           })
