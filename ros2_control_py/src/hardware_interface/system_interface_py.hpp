...
{
  py::class_<SystemInterface, rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface, PySystemInterface>(m, "SystemInterface")
      .def(py::init<>())
      .def("on_init", &SystemInterface::on_init)
      .def("on_export_state_interfaces", &SystemInterface::on_export_state_interfaces)
      .def("on_export_command_interfaces", &SystemInterface::on_export_command_interfaces)
      .def("prepare_command_mode_switch", &SystemInterface::prepare_command_mode_switch)
      .def("perform_command_mode_switch", &SystemInterface::perform_command_mode_switch)
