...
{
  py::class_<SensorInterface, rclcpp_lifecycle::node_interfaces::LifecycleNodeInterface, PySensorInterface>(m, "SensorInterface")
      .def(py::init<>())
      .def("on_init", &SensorInterface::on_init)
      .def("on_export_state_interfaces", &SensorInterface::on_export_state_interfaces)
